...
class Piggy(PiggyParent):
    ...
    *************
    ...
    def __init__(self, addr=8, detect=True):
        ...
        self.MIDPOINT = 1675  # what servo command (1000-2000) is straight forward for your bot?
    ...
    ****************
    ...
    def maze(self):
      ...
      while True:
        ...
        if self.read_distance() <= stopping_distance:
          ...
          if (left <= stopping_distance and center < stopping_distance and right > stopping_distance):
            self.right()
            time.sleep(1)
    ...
    def fwd_w_scan(self):
      ...
      while True:
        ...
        if (right <= stopping_distance and center > stopping_distance):
          self.swerve_left()
        
        elif (left <= stopping_distance and center > stopping_distance):
          self.swerve_right()
